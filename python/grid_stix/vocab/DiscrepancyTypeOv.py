"""
Open vocabulary for how a declared value relates to independently observed evidence. Domain-agnostic: applies to any Declaration/Discrepancy comparison, not a specific facility or asset type.
...
class DiscrepancyTypeOv(GridSTIXDomainObject):
    """
    Open vocabulary for how a declared value relates to independently observed evidence. Domain-agnostic: applies to any Declaration/Discrepancy comparison, not a specific facility or asset type.
    ...
    _type = "x-grid-discrepancy-type-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize DiscrepancyTypeOv with Grid-STIX properties."""

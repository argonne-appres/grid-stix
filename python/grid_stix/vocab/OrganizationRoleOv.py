"""
Open vocabulary for the role an organization plays with respect to grid or nuclear-safeguards infrastructure.
...
class OrganizationRoleOv(GridSTIXDomainObject):
    """
    Open vocabulary for the role an organization plays with respect to grid or nuclear-safeguards infrastructure.
    ...
    _type = "x-grid-organization-role-ov"
    ...
    def __init__(self, **kwargs: Any) -> None:
        """Initialize OrganizationRoleOv with Grid-STIX properties."""
